 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://fornitore-paasfab.rhcloud.com/jboss-as-helloworld-ws/HelloWorldService", wsdlLocation = "http://fornitore-paasfab.rhcloud.com/jboss-as-helloworld-ws/HelloWorldService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://fornitore-paasfab.rhcloud.com/jboss-as-helloworld-ws/HelloWorldService", "HelloWorldService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://fornitore-paasfab.rhcloud.com/jboss-as-helloworld-ws/HelloWorldService?wsdl");
    ...
    public HelloWorldService getHelloWorld() {
        return super.getPort(new QName("http://fornitore-paasfab.rhcloud.com/jboss-as-helloworld-ws/HelloWorldService", "HelloWorld"), HelloWorldService.class);
    }
    ...
    public HelloWorldService getHelloWorld(WebServiceFeature... features) {
        return super.getPort(new QName("http://fornitore-paasfab.rhcloud.com/jboss-as-helloworld-ws/HelloWorldService", "HelloWorld"), HelloWorldService.class, features);
    }
